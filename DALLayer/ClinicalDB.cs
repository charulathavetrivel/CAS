...
namespace DALLayer
{
    ...
    {
        //default constructor to initialize the database //The Name (CASDB) and the name in connection string must be same.
        public ClinicalDbContext() : base("name = CASDB") //base keyword is used to call the base class constructor(i.e in Dbcontext class constructor)
        {
